...
function LandingPage() {
  ...
  return (
    <div class="flex flex-col items-center justify-center h-full p-6 bg-gradient-to-br from-blue-100 to-green-100">
      ...
      <img src="https://images.unsplash.com/photo-1508062878650-88b52897f298?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjQ4Nzh8MHwxfHNlYXJjaHwxfHxjYXJ0b29uJTIwY29uc3RydWN0aW9uJTIwbWFzY290JTIwY2hhcmFjdGVyJTIwd2F2aW5nJTIwYXQlMjBraWRzJTIwb24lMjBhJTIwYnVpbGRpbmclMjBzaXRlfGVufDB8fHx8MTczMDk3ODAwOHww&ixlib=rb-4.0.3&q=80&w=1080"
